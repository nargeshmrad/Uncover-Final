document.addEventListener('DOMContentLoaded', () => {
  ...
  const reachLeftText = document.getElementById('reachLeftText');
  ...
  function showTextOverlay() {
    reachLeftText.style.display = 'block';
    reachLeftText.style.opacity = '1';
  }

  function hideTextOverlay() {
    reachLeftText.style.display = 'none';
    reachLeftText.style.opacity = '0';
  }
